...
// If salary not found it will be not disclosed, else it will be formatted as $ amount /period
...
export default function ListJobs() {
  ...
  // fetch details from backend and map to frontend format
          ...
          >
            ...
            <div className={s.modalContent}>
              ...
              <div className={s.sectionContainerLight}>
                ...
                <div className={s.imageUploadContainer}>
                  ...
                  <div className={s.imageUploadActions}>
                    ...
                    <Field
                      label="Upload Image"
                      icon={<ImageIcon size={14} className="text-[#8da1ad]" />}
                    >
              ...
              <div className={s.sectionContainer}>
                ...
                <div className={s.formGrid2}>
                  <div>
                    <Field
                      label="Role *"
                      icon={<Briefcase size={14} className="text-[#8da1ad]" />}
                    >
                      <input
                  ...
                  <div>
                    <Field
                      label="Company *"
                      icon={<Building2 size={14} className="text-[#8da1ad]" />}
                    >
                      <input
                  ...
                  <div>
                    <Field
                      label="Category"
                      icon={<Tag size={14} className="text-[#8da1ad]" />}
                    >
                      <select
                  ...
                  <div>
                    <Field
                      label="Job Type"
                      icon={<Clock size={14} className="text-[#8da1ad]" />}
                    >
                      <select
                    ...
                    <Field label="Locations" icon={<MapPin size={12} />}>
                      ...
                      <div className="flex flex-col gap-2">
                        {(editingJob?.locations || []).length === 0 && (
                          <div className="text-xs text-[#708694]">
              ...
              <div className={s.sectionContainer}>
                ...
                <div className={s.formGrid2}>
                  <div>
                    <label className="block text-xs font-medium text-[#708694] mb-2">
                      Education
                    </label>
                  ...
                  <div>
                    <Field
                      label="Openings"
                      icon={<Users size={14} className="text-[#8da1ad]" />}
                    >
                      <input
                        type="number"
                        min="1"
                    ...
                    <Field
                      ...
                      icon={<Calendar size={14} className="text-[#8da1ad]" />}
                    >
                      <input
                        type="date"
