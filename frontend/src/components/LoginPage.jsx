  ...
  return (
    <>
      ...
      <div className={s.pageContainer}>
        ...
        <div className={s.cardWrapper}>
          <div className={s.animatedBorderContainer}>
            <div className={s.cardInner}>
              ...
              {view === "login" && (
                <>
                  <h2 className={s.headerTitle}>Sign in to HireLane</h2>
        ...
        <div className={s.ballTop} style={s.ballTopStyle} />
        <div className={s.ballBottom} style={s.ballBottomStyle} />
      </div>
    </>
  );
};
