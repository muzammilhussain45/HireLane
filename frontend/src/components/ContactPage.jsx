...
const ContactPage = () => {
  ...
  const handleChange = (e) => {
    ...
    if (name === "phone") {
      ...
      setFormData((prev) => ({
        ...prev,
        phone: digitsOnly.slice(0, 10), // Limit to 10 digits
      }));
    } else {
      setFormData((prev) => ({
        ...prev,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        setToast({
          message: data.message || "Failed to send the message",
          type: "error",
        });
      }
    } catch (error) {
      ...
      <div className={s.mainWrapper}>
        ...
        <div className={s.header}>
          ...
          <p className={s.headerSubtitle}>
            We are excited to hear from you let's collaborate and create
